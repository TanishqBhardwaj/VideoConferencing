...
public class VideoChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras == null || !extras.containsKey(Constants.USER_NAME)) {
            ...
            Toast.makeText(this, "Need to pass username to VideoChatActivity " +
                            "in intent extras (Constants.USER_NAME).", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
    ...
    private class MyRTCListener extends PnRTCListener {
        ...
        public void onAddRemoteStream(final MediaStream remoteStream, final PnPeer peer) {
            VideoChatActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(VideoChatActivity.this,"Connected to " +
                            peer.getId(), Toast.LENGTH_SHORT).show();
                    try {
